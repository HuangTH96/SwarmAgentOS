...
// Local development/deployment backend. Override with QUASAR_API_URL when needed.
const baseUrl = process.env.QUASAR_API_URL || 'http://127.0.0.1:8081'
